      ...
      <div class="header_section">
         <div class="container-fluid">
            <nav class="navbar navbar-expand-lg navbar-light bg-light">
               <a class="navbar-brand"href="index.php"><img src="images/logo.png">&nbsp KAHVE</a>
               ...
               <div class="collapse navbar-collapse" id="navbarSupportedContent">
                  <ul class="navbar-nav ml-auto">
                     ...
                     <li class="nav-item">
                        <a class="nav-link" href="coffees.php">Ürünler</a>
                     </li>
                     <li class="nav-item">
                        ...
                        <div class="row">
                           ...
                           <div class="col-md-6">
                              <div class="banner_taital_main">
                                 ...
                                 <div class="btn_main">
                                    <div class="about_bt"><a href="about.php">Hakkımızda</a></div>
                                    <div class="callnow_bt active"><a href="tel:+905525366363">Bize Ulaşın</a></div>
                                 </div>
                              </div>
                           </div>
                        </div>
